<x-app-layout>
    ...
    <div class="container">
        ...
        <div class="flex items-center justify-between">
            <h2 class="text-bold text-2xl text-black">Manage Borrow</h2>
            <a href="{{ route('borrow.create') }}" ><button class="h-fit min-h-fit py-2 px-4 btn btn-info text-white">Add</button></a>
        </div>
                        ...
                        <tr>
                            ...
                            <td class="text-black">
                                <div class="flex items-center gap-2">
                                    <a href="{{ route('borrow.edit', $record->id) }}" ><button class="h-fit min-h-fit py-2 px-4 btn btn-info text-white">Edit</button></a>
                                    <form action="{{ route('borrow.destroy', $record->id) }}" method="POST" style="display: inline-block;">
                                        @csrf
                                        @method('DELETE')
