<x-app-layout>
    ...
    <div class="container">
        ...
        <div class="flex items-center justify-between">
            <h2 class="text-bold text-2xl text-black">Borrow Report</h2>
        </div>
        ...
        <div class="flex">
                ...
                <div class="flex">
                    <div class="mt-3">
                        ...
                        <label class="input input-bordered bg-white flex items-center gap-2 mt-2">
                            ...
                            <input type="date" class="grow text-black" name="start_date" id="start_date" value="{{ request('start_date') }}" />
                        </label>
                    </div>
                    ...
                    <div class="mt-3 ms-3">
                        ...
                        <label class="input input-bordered bg-white flex items-center gap-2 mt-2">
                            <x-fas-calendar-day class="w-4 h-4 opacity-70 text-black"/>
                            <input type="date" class="grow text-black" name="end_date" id="end_date" value="{{ request('end_date') }}" />
                        </label>
                    </div>

                    <div class="mt-3 ms-3">
                        <br>
                        <button type="submit" class="btn btn-info btn-md bg-blue-500 text-white mt-2">Search</button>
                    </div>
                </div>
            </form>
            ...
            <form method="POST" action="{{ route('report.export') }}">
                ...
                <div class="mt-3 ms-3">
                    <br>
                    <button type="submit" class="btn btn-info btn-md bg-blue-300 mt-2">Export</button>
                </div>
            </form>
        </div>
                        ...
                        <tr>
                            <td class="text-black">
                                <div class="flex items-center">
                                    ...
                                    @if (($record->borrow_status == 'In Borrowed' || $record->borrow_status == 'Penalty') && \Carbon\Carbon::parse($record->borrow_end_date)->isPast())
