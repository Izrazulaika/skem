        ...
        <div class="card w-full base-100 mt-5 mb-5 border border-gray-300">
            <div class="card-title bg-blue-500 text-white px-4 py-3 rounded-t-lg">
                <div class="flex items-center justify-between w-full">
                    <h2 class="text-bold text-xl text-white">Add New Student</h2>
            ...
            <div class="card-body">
                ...
                <form action="{{ route('students.store') }}" method="POST" class="form-group">
                    ...
                    <label class="input input-bordered bg-white flex items-center gap-2 mt-2">
                        ...
                        <input type="text" class="grow text-black" placeholder="Student ID" name="student_id" required />
                    </label>
                    ...
                    <button type="submit" class="btn btn-info btn-md bg-blue-500 text-white mt-3">Add Student</button>
                </form>
            </div>
        </div>
    </div>
