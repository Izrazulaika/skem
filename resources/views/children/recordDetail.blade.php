        ...
        <div class="card w-full base-100 mt-5 mb-5 border border-gray-300">
            <div class="card-title bg-blue-500 text-white px-4 py-3 rounded-t-lg">
                <div class="flex items-center justify-between w-full">
                    ...
                    <a href="{{ route('children.parentBorrows') }}" ><button class="h-fit min-h-fit py-2 px-4 btn btn-info text-white">Back</button></a>
                </div>
            </div>
            <div class="card-body">
                        ...
                        <div class="grid grid-cols-2 gap-2">
                            ...
                            <div class="mt-3">
                                ...
                                <label class="input input-bordered bg-white flex items-center gap-2 mt-2">
                                    ...
                                    <input type="date" class="grow text-black" value="{{ $borrow->borrow_start_date }}" name="borrow_start_date" id="borrow_start_date" readonly />
                                </label>
                            ...
                            <div class="mt-3">
                                ...
                                <label class="input input-bordered bg-white flex items-center gap-2 mt-2">
                                    <x-fas-calendar-day class="w-4 h-4 opacity-70 text-black"/>
                                    <input type="date" class="grow text-black" name="borrow_end_date" id="borrow_end_date"  value="{{ $borrow->borrow_end_date }}" min="{{ \Carbon\Carbon::tomorrow()->toDateString() }}" readonly />
                                </label>
                            ...
                            <div class="mt-3">
                                ...
                                <label class="input input-bordered bg-white flex items-center gap-2 mt-2">
                                    ...
                                    <select disabled name="borrow_status" class="grow bg-transparent text-black">
